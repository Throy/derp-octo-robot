...
namespace IndignadoServer.LinqDataContext
{
    ...
    partial void OnidMovimientoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Usuario1_UsuarioFacebook", Storage="_Usuario", ThisKey="idUsuario", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnprivilegioChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Usuario1_UsuarioFacebook", Storage="_UsuarioFacebooks", ThisKey="id", OtherKey="idUsuario")]
